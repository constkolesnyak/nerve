    ...
    return (
      <div>
        <button
          ...
          className="flex items-center gap-1.5 w-full text-left px-2 py-1 text-[13px] text-[#999] hover:bg-surface-raised cursor-pointer rounded"
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 w-full text-left px-2 py-1 text-[13px] cursor-pointer rounded
        ${isSelected ? 'bg-[#1f1f2f] text-text' : 'text-text-muted hover:bg-surface-raised hover:text-[#bbb]'}`}
